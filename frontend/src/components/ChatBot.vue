...
<template>
  <div class="fixed bottom-6 right-6 z-50">
    ...
    <div
      v-else
      class="w-96 h-[500px] rounded-xl flex flex-col overflow-hidden shadow-2xl border"
      :class="[
        isNightshade()
