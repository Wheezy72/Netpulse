...
function accentClass(accent: string): string {
  ...
  if (accent === "blue") return "text-emerald-400 bg-emerald-500/10";
    ...
    <header class="flex items-end justify-between px-1">
      ...
      <div class="flex items-center gap-2 rounded-full border border-white/[0.04] bg-[#0B0F17]/80 px-3 py-1.5 backdrop-blur-md">
        <span
          ...
          :class="heartbeatActive ? 'bg-emerald-400 shadow-[0_0_16px_rgba(217,70,239,0.55)]' : 'bg-white/20'"
        />
        ...
        <div class="space-y-5 px-5 py-4">
          <section class="space-y-3">
            <div>
              ...
              class="mt-2 w-full rounded-2xl border border-white/[0.04] bg-black/40 px-4 py-3 np-mono text-[12px] text-white outline-none placeholder:text-white/20 focus:border-emerald-400/40"
              />
            </div>
            ...
            <div class="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  v-model="splunkIndex"
                  type="text"
                  class="mt-2 w-full rounded-2xl border border-white/[0.04] bg-black/40 px-4 py-3 np-mono text-[12px] text-white outline-none focus:border-emerald-400/40"
                />
              </div>
            </div>
            ...
            <div class="flex items-center justify-between rounded-2xl border border-white/[0.04] bg-white/[0.03] px-4 py-3">
              ...
              <div
                class="h-2.5 w-2.5 rounded-full"
                :class="heartbeatActive ? 'bg-emerald-400 shadow-[0_0_18px_rgba(217,70,239,0.65)]' : 'bg-white/15'"
              />
            </div>
          </section>
